...
export type ResumeTemplate =
  'professional' | 'modern' | 'creative' | 'minimal' | 'executive' | 'technical'

export type ResumeVisibility = 'public' | 'private' | 'employers-only'
...
export interface AIJobGenerationDto {
  jobTitle: string
  companyName?: string
  field: 'description' | 'requirements' | 'responsibilities' | 'benefits' | 'skills' | 'summary'
}
