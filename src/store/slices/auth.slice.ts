...
interface AuthState {
  user: AuthResponseDto['data']['user'] | null
...
export const { setCredentials, clearCredentials, clearError, clearSuccess, setLoading } =
  authSlice.actions
...
export const selectIsVerifying = (state: { auth: AuthState }) => state.auth.isVerifying
